...
//   credited: {
//     label: "Credited",
//     color: "var(--secondary)", // Change color for credited
//   },
// };

// export function ChartAreaInteractive({ accounts }: Props) {
//   const isMobile = useIsMobile();
//   const [timeRange, setTimeRange] = React.useState("90d");
//   const [selectedAccount, setSelectedAccount] = React.useState(accounts[0]?.accountName || "");
...
//   const filteredData = selectedAccountData.filter((item) => {
...
//                 <SelectItem key={account.accountName} value={account.accountName} className="rounded-lg">
//                   {account.accountName}
//                 </SelectItem>
//               ))}
//             </SelectContent>
